...
public class ContainerAdvancedEnchantmentTable extends Container
{
    ...
    public final IInventory tableInventory = new SlotAdvancedEnchantmentTable(this, "Enchant", true, 1);
    final TileEntityAdvancedEnchantmentTable tileEnchantTable;
    ...
    public ContainerAdvancedEnchantmentTable(final InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5, TileEntityAdvancedEnchantmentTable tileEntity) {
        worldObj = par2World;
        xPos = par3;
        yPos = par4;
        zPos = par5;
